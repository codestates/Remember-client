      ...
      <form className="service__pay__box">
        ...
        <div className="radio__row">
          ...
          <div className="radio__group">
            ...
            <div className="service__pay__radio">
              <input type="radio" name="check"  onClick={() => setValues({...values, group: "법인"})}/>{" "}
            </div>
        ...
        <div className="service__pay__row">
          <div className="input__group">
            ...
            { values.group === "법인" ? <input placeholder="법인명" value={company} onChange={(e) => setCompany(e.target.value)} className="input__group-input"/>
            : values.group === "학교단체" ? <input placeholder="학교 or 단체명" value={group} onChange={(e) => setGroup(e.target.value)} className="input__group-input"/>
            : values.group === "개인" ? <input readOnly value={name} className="input__group-input"/>
            : <input readOnly placeholder="자신이 속한 그룹을 선택해주세요" className="input__group-input"/>}
          </div>
          <div className="input__group">
